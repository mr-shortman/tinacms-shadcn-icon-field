...
const iconColorClass: {
  ...
  primary: {
    regular: "text-primary opacity-80",
    circle: "bg-primary dark:bg-primary text-primary-foreground",
  },
};
  ...
  if (style == "circle") {
    return (
      <div
        ...
        className={cn(
          `relative z-10 inline-flex items-center justify-center flex-shrink-0 ${iconSizeClasses} rounded-full ${iconColorClass[iconColor].circle}`,
          className
        )}
      >
    ...
    return (
      <IconSVG
        data-tina-field={tinaField}
        className={cn(`${iconSizeClasses} ${iconColorClasses}`, className)}
      />
    );
  }
};
